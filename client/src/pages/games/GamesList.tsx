...
const games = [
  {
    ...
    image: "/games/Colorful Color Pick.webp",
  ...
  },
  {
    ...
    image: "/games/Run, Pixel Cat.webp",
    href: "/games/runner",
    tag: "🐱 아케이드",
  ...
  },
  {
    ...
    image: "/games/Pyong Pyong Ball Touch.webp",
    href: "/games/reaction",
    tag: "🎈 반응",
  ...
  },
  {
    ...
    image: "/games/Perfect Angle 10 Sec.webp",
  ...
  },
  {
    ...
    description:
      "냥이와 함께하는 블록 쌓기! 라인을 완성하며 최고 점수에 도전하세요",
    image: "/games/Block Cat's Tower Stack.webp",
    href: "/games/tetris",
    tag: "🧱 스킬",
  ...
  },
  {
    id: "ironpaw-survival",
    title: "아이언포 서바이벌",
    subtitle: "IronPaw Survival",
    description:
      "뱀파이어 서바이벌 스타일! 30분간 생존하며 무기를 업그레이드하세요",
    image: "/games/IronPaw Survival.webp",
    href: "/games/ironpaw-survival",
    tag: "⚔️ 서바이벌",
          ...
          {games.map((game) => (
            <Link key={game.id} to={game.href}>
              <NeoCard className="aspect-square overflow-hidden active:translate-x-1 active:translate-y-1 active:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer p-0 relative group">
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${game.gradient} opacity-0 group-active:opacity-30 transition-opacity duration-300`}
                ></div>
